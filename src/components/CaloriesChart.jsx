...
const CaloriesChart = () => {
    ...
    const getData = () => {
        ...
        for (let i = 6; i >= 0; i--) {
            ...
            const dailyFood = allFoodLogs.filter(log => log.createdAt && log.createdAt.split('T')[0] === dateString);
            const dailyActivity = allActivityLogs.filter(log => log.createdAt && log.createdAt.split('T')[0] === dateString);
    ...
    return (
        <div className="w-100 mt-4" style={{ height: "300px" }}>
